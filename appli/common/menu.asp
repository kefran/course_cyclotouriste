...
<select id='m1' style="position:absolute;width:100px;margin:0 0 0 0;float:left;" onmouseover="this.size=this.length;" onmouseout="this.size=1;" onchange="document.location=this.value" >
...
<select id='m2' style="position:absolute;width:170px;margin:0 0 0 110px;float:left;" onmouseover="this.size=this.length;" onmouseout="this.size=1;" onchange="document.location=this.value" >
	...
	<select id='m3' style="position:absolute;width:175px;margin:0 0 0 290px;float:left;" onmouseover="this.size=this.length;" onmouseout="this.size=1;"  onchange="document.location=this.value" >
	...
	<select id='m4' style="position:absolute;width:180px;margin:0 0 0 475px;float:left;" onmouseover="this.size=this.length;" onmouseout="this.size=1;" onchange="document.location=this.value" >
	...
	<select id='m5'  style="position:absolute;width:110px;margin:0 0 0 665px;float:left;" onmouseover="this.size=this.length;" onmouseout="this.size=1;" onchange="document.location=this.value" >
	...
	<select id='m6' style="position:absolute;width:110px;margin:0 0 0 785px;float:left;" onmouseover="this.size=this.length;" onmouseout="this.size=1;" onchange="document.location=this.value" >
